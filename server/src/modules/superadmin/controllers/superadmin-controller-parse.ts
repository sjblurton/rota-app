...
export const parseCreateOrganisationBody = (
  request: Request,
  response: Response,
) =>
...
export const parseUpdateOrganisationBody = (
  request: Request,
  response: Response,
) =>
  parseOrSendBadRequest(
...
export const parseOrganisationIdParams = (
  request: Request,
  response: Response,
) =>
  parseOrSendBadRequest(
...
export const parseOrganisationManagerIdsParams = (
  request: Request,
  response: Response,
) =>
  parseOrSendBadRequest(
